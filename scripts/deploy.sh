...
echo "Building container for grlink v$VERSION"
# Build the docker container
docker build -t gauchoracing/grlink:"$VERSION" -t gauchoracing/grlink:latest --platform linux/amd64,linux/arm64 --push --progress=plain .
